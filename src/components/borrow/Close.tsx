...
function Close() {
    ...
    const receiveStETH = (Math.round((parseFloat(stEthDeposit) * .995) * 100000000) / 100000000).toString()
    const receiveUsdStETH = (Math.round(((parseFloat(stEthDeposit) * .995 * ETH)) * 100000000) / 100000000).toFixed(2)
